...
const menuItemsAbit = ref([
  { id: 1, title: "Карта вступника", color: '#00a53f', component: AbiturientMap, image: 'img/route.png' },
  { id: 2, title: "Спеціальності", color: '#27ae60', icon: '🎓', component: Speciality }, 
  { id: 3, title: "Державне замовлення", color: '#2ecc71', icon: '📄' }
]);
